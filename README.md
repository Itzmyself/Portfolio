...
```bash
   cd <your-repo-name>
```
3. Make sure the `assets/` folder is present with all images and the `Rain.mp4` video file.
...
If you use VS Code, install the [Live Server extension](https://marketplace.visualstudio.com/items?itemName=ritwickdey.LiveServer), right-click `index.html`, and select **"Open with Live Server"**. This ensures the video background autoplays correctly.
...
- LinkedIn: [linkedin.com/in/shyam-kumar-124868320](https://www.linkedin.com/in/shyam-kumar-124868320)
- GitHub: [github.com/Itzmyself](https://github.com/Itzmyself)
